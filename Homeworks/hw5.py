...
def make_withdraw(balance, password):
    ...
    "*** YOUR CODE HERE ***"
    password_attempts = []
    def check_withdraw(amount,phrase):
            ...
            if phrase == password:
                ...
                password_attempts.append(phrase)
...
def make_joint(withdraw, old_password, new_password):
    ...
    if type(result) != str:
        def add_joint(amount, new_phrase):
            if new_password == new_phrase:
                return withdraw(amount,old_password)
            else: 
                return withdraw(amount, new_phrase)
        return add_joint
    return result
